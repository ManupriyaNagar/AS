...
export default function ContactSection() {
        ...
        {[
  {
    ...
    stateZip: 'Karnataka-560099',
    email: 'sales@activesine.com',
    website: 'www.activesine.com',
    phone1: '+91 99 0103 4214',
    phone2: '+91 80 6878 5509',
  },
].map((office, index) => (
  <div
    key={index}
    className="bg-gradient-to-br from-white to-blue-50 shadow-2xl rounded-xl p-6 flex flex-col justify-between transform hover:scale-[1.02] hover:shadow-3xl transition-all duration-500 ease-in-out max-w-sm mx-auto border border-blue-100 relative group"
  >
    {/* Floating Icon */}
    ...
    <div className="grid grid-cols-2 gap-3 mb-1">
      ...
      <a
  href="https://wa.me/+919663987182"  // Replace with your number
  target="_blank"
  rel="noopener noreferrer"
>
  <button className="flex items-center justify-center gap-2 bg-gradient-to-r from-gray-600 to-gray-700 text-white px-8 py-3 rounded-xl hover:from-gray-700 hover:to-gray-800 transform hover:-translate-y-0.5 transition-all duration-300 shadow-lg hover:shadow-xl">
    <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z" />
    </svg>
    Message
